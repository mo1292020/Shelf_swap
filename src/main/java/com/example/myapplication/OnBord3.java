...
public class OnBord3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button getStart = findViewById(R.id.onbord3_start);

        getStart.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                SharedPreferences preferences = getSharedPreferences("App", Context.MODE_PRIVATE);
                preferences.edit().putBoolean("firstRun", false).apply();
                startActivity(new Intent(OnBord3.this, SignUp.class));
                finish();
            }
        });

        Button skip = findViewById(R.id.onbord3_skip);
        ...
        radioGroup.setOnCheckedChangeListener(new RadioGroup.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(RadioGroup radioGroup, int i) {
                ...
                else if(radio.getText().equals("onbord2")){
